...
"""autogenerated by genpy from ex1_serial/Message.msg. Do not edit."""
import sys
...
class Message(genpy.Message):
  _md5sum = "7d65c7bbd4f88c12c49b0057e6c0ecce"
  _type = "ex1_serial/Message"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Custom data type for packets
uint8[] data
uint8 size
"""
  __slots__ = ['data','size']
